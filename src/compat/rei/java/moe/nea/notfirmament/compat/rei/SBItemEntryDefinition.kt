...
import moe.nea.notfirmament.compat.rei.NotFirmamentReiPlugin.Companion.asItemEntry
...
object SBItemEntryDefinition : EntryDefinition<SBItemStack> {
	...
	override fun getType(): EntryType<SBItemStack> = EntryType.deferred(NotFirmamentReiPlugin.SKYBLOCK_ITEM_TYPE_ID)
