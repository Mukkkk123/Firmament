...
import moe.nea.notfirmament.compat.rei.recipes.GenericREIRecipeCategory
import moe.nea.notfirmament.compat.rei.recipes.SBKatRecipe
import moe.nea.notfirmament.compat.rei.recipes.SBMobDropRecipe
import moe.nea.notfirmament.compat.rei.recipes.SBRecipe
import moe.nea.notfirmament.compat.rei.recipes.SBReforgeRecipe
import moe.nea.notfirmament.compat.rei.recipes.SBShopRecipe
import moe.nea.notfirmament.events.HandledScreenPushREIEvent
import moe.nea.notfirmament.features.inventory.CraftingOverlay
...
import moe.nea.notfirmament.repo.recipes.SBCraftingRecipeRenderer
import moe.nea.notfirmament.repo.recipes.SBEssenceUpgradeRecipeRenderer
import moe.nea.notfirmament.repo.recipes.SBForgeRecipeRenderer
import moe.nea.notfirmament.util.MC
import moe.nea.notfirmament.util.SkyblockId
import moe.nea.notfirmament.util.guessRecipeId
import moe.nea.notfirmament.util.skyblockId
import moe.nea.notfirmament.util.unformattedString


class NotFirmamentReiPlugin : REIClientPlugin {
	...
	companion object {
		...
		val SKYBLOCK_ITEM_TYPE_ID = Identifier.fromNamespaceAndPath("notfirmament", "skyblockitems")
	}
