...
import moe.nea.notfirmament.repo.Reforge
import moe.nea.notfirmament.repo.ReforgeStore
import moe.nea.notfirmament.repo.RepoItemTypeCache
import moe.nea.notfirmament.repo.RepoManager
import moe.nea.notfirmament.repo.SBItemStack
import moe.nea.notfirmament.util.AprilFoolsUtil
...
class SBReforgeRecipe(
	...
	companion object {
		val catIdentifier = CategoryIdentifier.of<SBReforgeRecipe>(NotFirmament.MOD_ID, "reforge_recipe")
	}
	...
	object Category : DisplayCategory<SBReforgeRecipe> {
		...
		override fun getTitle(): Component {
			return tr("notfirmament.recipecategory.reforge", "Reforge")
		}
		...
		override fun setupDisplay(display: SBReforgeRecipe, bounds: Rectangle): MutableList<Widget> {
			...
			if (display.reforgeStone != null) {
				...
				list.add(Widgets.withTooltip(
					...
					tr("notfirmament.recipecategory.reforge.basic",
