...
public class AutoDiscoveryPlugin {
	public static List<String> getDefaultAllMixinClassesFQNs() {
		var defaultName = "moe.nea.notfirmament.mixins";
	...
	public List<String> getMixins() {
		...
		try {
			...
			var classRoots = System.getProperty("notfirmament.classroots");
			if (classRoots != null && !classRoots.isBlank()) {
				System.out.println("Found notfirmament class roots: " + classRoots);
