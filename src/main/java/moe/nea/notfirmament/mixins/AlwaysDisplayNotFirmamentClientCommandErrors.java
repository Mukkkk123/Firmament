...
public class AlwaysDisplayNotFirmamentClientCommandErrors {
	...
	private static boolean markNotFirmamentExceptionsAsNotIgnores(boolean original, @Local(argsOnly = true) String command) {
		if (command.startsWith("firm ") || command.equals("firm") || command.startsWith("notfirmament ") || command.equals("notfirmament")) {
			return false;
		}
		return original;
	}
