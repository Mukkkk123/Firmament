 ...
 */
data class ProcessChatEvent(val text: Component, val wasExternallyCancelled: Boolean) : NotFirmamentEvent.Cancellable() {
    ...
    companion object : NotFirmamentEventBus<ProcessChatEvent>()
}
