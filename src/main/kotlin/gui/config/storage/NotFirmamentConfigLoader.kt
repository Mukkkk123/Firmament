...
import moe.nea.notfirmament.util.SBData.NULL_UUID
import moe.nea.notfirmament.util.TimeMark
import moe.nea.notfirmament.util.data.IConfigProvider
import moe.nea.notfirmament.util.data.IDataHolder
import moe.nea.notfirmament.util.data.ProfileKeyedConfig
import moe.nea.notfirmament.util.json.intoGson
import moe.nea.notfirmament.util.json.intoKotlinJson

object NotFirmamentConfigLoader {
	val currentConfigVersion = 1000
	val configFolder = Path("config/notfirmament")
		.toAbsolutePath()
