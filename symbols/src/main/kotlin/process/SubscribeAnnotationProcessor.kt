...
class SubscribeAnnotationProcessor(
    ...
    override fun finish() {
        ...
        val subscriptionsFile =
            codeGenerator
                .createNewFile(dependencies, "moe.nea.notfirmament.annotations.generated.$sourceSetName", generatedFileName)
                .bufferedWriter()
        subscriptionsFile.apply {
            appendLine("// This file is @generated by SubscribeAnnotationProcessor")
            appendLine("// Do not edit")
            appendLine("package moe.nea.notfirmament.annotations.generated.$sourceSetName")
            appendLine()
            appendLine("import moe.nea.notfirmament.events.subscription.*")
            appendLine()
	        appendLine("@Suppress()")
        ...
        val metaInf = codeGenerator.createNewFileByPath(
            dependencies,
            "META-INF/services/moe.nea.notfirmament.events.subscription.SubscriptionList", extensionName = "")
            .bufferedWriter()
